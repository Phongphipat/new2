...
<head>
    ...
    <style>
        ...
        .auth-card {
            ...
            box-shadow: 0 20px 50px rgba(38, 57, 77, .25);
            overflow: hidden;
        }
        ...
        <div class="card-body">
            <?php if ($message): ?>
                <div class="alert alert-<?php echo htmlspecialchars($variant); ?> d-flex align-items-center" role="alert">
                    <i
                        class="bi <?php echo $variant === 'success' ? 'bi-check-circle-fill' : ($variant === 'warning' ? 'bi-exclamation-circle-fill' : 'bi-exclamation-triangle-fill'); ?> me-2"></i>
                ...
                <div class="mb-3">
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary" type="button" id="toggleConfirm"
                            aria-label="สลับการมองเห็นยืนยันรหัสผ่าน">
                            <i class="bi bi-eye"></i>
                        </button>
                    </div>
